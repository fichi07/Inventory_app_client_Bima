                  ...
                  <div class="col-12">
                    <div class="form-group">
                        ...
                        <select name="remarks" id="remarks" class="form-control">
                            <option value="Disetujui" {{ (empty(old('remarks')) && $item->remarks === 'Disetujui') || old('remarks') === 'Disetujui' ? 'selected' : '' }}>Disetujui</option>
                            <option value="Belum Disetujui" {{ (empty(old('remarks')) && $item->remarks === 'Belum Disetujui') || old('remarks') === 'Belum Disetujui' ? 'selected' : '' }}>Belum Disetujui</option>
                        </select>
                    </div>
                </div>
